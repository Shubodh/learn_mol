...
get_ipython().system('pip install git+https://github.com/zotko/xyz2graph.git plotly networkx torch_geometric rdkit')
...
get_ipython().system('pip install torch-scatter torch-sparse torch-cluster -f https://data.pyg.org/whl/torch-{torch.__version__}.html')
